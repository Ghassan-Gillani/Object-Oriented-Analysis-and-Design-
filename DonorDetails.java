...
public class DonorDetails extends javax.swing.JFrame {
    ...
    controller c;
    static String name;
    public DonorDetails(String cnic) {
        c = new controller();
        DonorDetails.name = c.getname(cnic);
        initComponents();
        Donor d = c.getDonorFull(cnic);
        donorname.setText(d.getName());
        donorphone.setText(d.getPh());
        donorcnic.setText(d.getCNIC());
        donordob.setText(d.getDOB());
        donoraddress.setText(d.getAddress());
        totalcash.setText(Integer.toString(d.amount));
        totalwheat.setText(Integer.toString(d.weight));
        ArrayList <String> temp = d.ProjectNames;
        ...
        jScrollPane4.setViewportView(projectsList);
    }
    ...
    private void projectsListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_projectsListValueChanged
        ...
        int amount1 = c.getdonorprojectamount(name, project);
        int weight1 = c.getdonorprojectweight(name, project);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new DonorDetails(name).setVisible(true);
        });
    }
